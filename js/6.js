...
function setGame() {
  ...
  if (difficulty == 4) {
    time = 20000;
    length = 8;
    descr1.innerHTML ="Цель игры - собрать число из фрагментов по возрастанию цифр, время ограничено. <br>ЛКМ - взять фрагмент. Enter - начать игру.";
  } else {
    descr1.innerHTML =
      "Вам будет показано число. Цель игры - собрать его из фрагментов за время. <br>ЛКМ - взять фрагмент. Enter - начать игру.";
  }
}

let clicks = 0;
let array1 = ["Consuetudo est altera natura","Nota bene","Nulla calamitas sola","Per aspera ad astra"];
let array2 = ["Привычка - вторая натура","Заметьте хорошо!","Беда не приходит одна","Через тернии к звёздам"];
let node1;
let node2;
let node3;
